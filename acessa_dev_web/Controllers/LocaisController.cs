...
namespace acessa_dev_web.Controllers
{
    public class LocaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idLocal,Nome,Endereco,Latitude,Longitude")] Local local)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idLocal,Nome,Endereco,Latitude,Longitude")] Local local)
        {
            if (id != local.idLocal)
            {
                return NotFound();
